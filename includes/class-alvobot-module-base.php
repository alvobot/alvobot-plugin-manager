...
abstract class AlvoBotPro_Module_Base {
    ...
    public function enqueue_admin_assets($hook) {
        ...
        if ($module_js) {
            ...
            wp_localize_script('alvobot-pro-' . $this->module_id, $js_var_name, array(
                ...
                <div class="alvobot-admin-header">
                    <h1>
                        <?php if ($this->module_icon): ?>
                            <span class="alvobot-module-icon"><?php echo $this->module_icon; ?></span>
                        <?php endif; ?>
                        <?php echo esc_html($this->module_name); ?>
                    </h1>
