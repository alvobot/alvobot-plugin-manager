...
<div class="cta-builder-layout">
	...
	<div class="cta-builder-preview">
		...
		<div class="preview-footer">
			<div class="cta-stats">
				<span><i data-lucide="palette" class="alvobot-icon" style="width:14px;height:14px;"></i> <strong id="stats-template"><?php _e( 'Nenhum', 'alvobot-pro' ); ?></strong></span>
				<span><i data-lucide="link" class="alvobot-icon" style="width:14px;height:14px;"></i> <strong id="stats-url"><?php _e( 'Não definida', 'alvobot-pro' ); ?></strong></span>
			</div>
		</div>
	</div>
</div>
