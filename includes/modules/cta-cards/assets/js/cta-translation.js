...
jQuery(document).ready(function($) {
    ...
    function addBlockEditorButton() {
        ...
        if ($('.edit-post-header-toolbar').length && !$('.alvobot-cta-translate-floating').length) {
            $('body').append(
                ...
                '<span>' + alvobotCTATranslation.strings.translate_cta + '</span>' +
                '</button>' +
                '</div>'
            );
            ...
            $('<style>')
                ...
                .html(`
                    ...
                    .alvobot-cta-translate-floating .dashicons {
                        font-size: 16px;
                        width: 16px;
                        height: 16px;
                    }
    ...
    function openTranslationModal() {
        ...
        $modal.find('.alvobot-modal-body p').text(
    ...
    function getPostId() {
        ...
        if (typeof typenow !== 'undefined' && typeof pagenow !== 'undefined') {
            const postIdFromBody = $('body').attr('class').match(/postid-(\d+)/);
