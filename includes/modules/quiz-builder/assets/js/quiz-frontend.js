		...
		form.addEventListener('submit', function (event) {
			...
			if (urlMode === 'params') {
                ...
                */
				...
				console.log(
					'[ALVOBOT DEBUG] Suffix mode - letting form submit naturally (this should NOT happen if no forms exist)',
				);
			}
			...
			radio.addEventListener('change', function () {
				...
				setTimeout(function () {
					...
					if (selectedRadio) {
						...
						const existingCurrentAnswer = form.querySelectorAll(
							'input[name="current_answer"][type="hidden"]',
						);
