...
$export_url = add_query_arg(array_merge(
    array('page' => 'alvobot-quiz-builder', 'tab' => 'submissions', 'export' => 'csv'),
        ...
        <div class="alvobot-pagination">
            ...
            <div class="alvobot-pagination-links">
                ...
                $base_url = add_query_arg(array_merge(
                    array('page' => 'alvobot-quiz-builder', 'tab' => 'submissions'),
                    array_filter($filters)
                ), admin_url('admin.php'));
...
.alvobot-whatsapp-link .dashicons {
    font-size: 14px;
    width: 14px;
    height: 14px;
    color: #25D366;
