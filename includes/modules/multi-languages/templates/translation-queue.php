					...
					<div class="alvobot-toolbar-left">
						<div class="alvobot-btn-group">
							...
							<button type="button" class="alvobot-btn alvobot-btn-warning" id="reset-orphaned" title="Reseta itens travados em processamento">
								<i data-lucide="history" class="alvobot-icon"></i>
...
jQuery(document).ready(function($) {
	...
	class QueueManager {
				...
				<div style="display: flex; gap: 4px; justify-content: center;">
					...
					${canDelete ?
						...
						`<button class="alvobot-btn-icon" disabled title="Item em processamento">
							<i data-lucide="trash-2" class="alvobot-icon" style="opacity: 0.3;"></i>
						</button>`
					}
				</div>
			`;
		...
		buildDetailsHtml(item, details) {
			...
			html += '<h3><i data-lucide="search" class="alvobot-icon" style="width:18px;height:18px;vertical-align:middle;margin-right:4px;"></i> Informações Básicas</h3>';
			...
			html += '<div class="alvobot-section-header">';
			html += '<h3><i data-lucide="globe" class="alvobot-icon" style="width:18px;height:18px;vertical-align:middle;margin-right:4px;"></i> Configuração de Idiomas</h3>';
			...
			html += '<div class="alvobot-details-section">';
			html += '<div class="alvobot-section-header">';
			html += '<h3><i data-lucide="clock" class="alvobot-icon" style="width:18px;height:18px;vertical-align:middle;margin-right:4px;"></i> Histórico de Data/Hora</h3>';
			...
			if (details.settings) {
				html += '<div class="alvobot-details-section">';
				html += '<div class="alvobot-section-header">';
				html += '<h3><i data-lucide="settings" class="alvobot-icon" style="width:18px;height:18px;vertical-align:middle;margin-right:4px;"></i> Configurações da Tradução</h3>';
			...
			if (details.post_data) {
				html += '<div class="alvobot-details-section">';
				html += '<div class="alvobot-section-header">';
				html += '<h3><i data-lucide="file-text" class="alvobot-icon" style="width:18px;height:18px;vertical-align:middle;margin-right:4px;"></i> Dados do Post Original</h3>';
			...
			if (details.translation_system) {
				html += '<div class="alvobot-details-section">';
				html += '<div class="alvobot-section-header">';
				html += '<h3><i data-lucide="wrench" class="alvobot-icon" style="width:18px;height:18px;vertical-align:middle;margin-right:4px;"></i> Sistema de Tradução</h3>';
			...
			if (details.metrics) {
				html += '<div class="alvobot-details-section">';
				html += '<div class="alvobot-section-header">';
				html += '<h3><i data-lucide="bar-chart-3" class="alvobot-icon" style="width:18px;height:18px;vertical-align:middle;margin-right:4px;"></i> Métricas e Estatísticas</h3>';
			...
			if (item.error_log && item.error_log !== 'NULL' && item.error_log !== '') {
				html += '<div class="alvobot-details-section">';
				html += '<div class="alvobot-section-header">';
				html += '<h3><i data-lucide="alert-triangle" class="alvobot-icon" style="width:18px;height:18px;vertical-align:middle;margin-right:4px;"></i> Log de Erros</h3>';
			...
			if (details.logs && details.logs.length > 0) {
				html += '<div class="alvobot-details-section">';
				html += '<div class="alvobot-section-header">';
				html += '<h3><i data-lucide="clipboard-list" class="alvobot-icon" style="width:18px;height:18px;vertical-align:middle;margin-right:4px;"></i> Logs Detalhados</h3>';
			...
			html += '<div class="alvobot-details-section">';
			html += '<div class="alvobot-section-header">';
			html += '<h3><i data-lucide="code" class="alvobot-icon" style="width:18px;height:18px;vertical-align:middle;margin-right:4px;"></i> Dados RAW Completos</h3>';
		...
		buildLogsPhaseHtml(data) {
			...
			if (Array.isArray(data) && data.length > 0) {
				...
				if (logsWithPayloads.length > 0) {
					html += '<h5><i data-lucide="radio" class="alvobot-icon" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;"></i> Logs com Payloads OpenAI (' + logsWithPayloads.length + '):</h5>';
					...
					logsWithPayloads.forEach((log, index) => {
						...
						html += `<i data-lucide="radio" class="alvobot-icon" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;"></i> Request/Response ${index + 1} - ${log.timestamp || 'N/A'}`;
						html += `</div>`;
						...
						if (log.structured_data) {
							...
							if (structData.headers) {
								...
								html += '<h6><i data-lucide="key" class="alvobot-icon" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;"></i> Headers da Requisição:</h6>';
							...
							if (structData.payload) {
								html += '<div class="alvobot-payload-section">';
								html += '<h6><i data-lucide="upload" class="alvobot-icon" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;"></i> Payload da Requisição:</h6>';
							...
							if (structData.curl_equivalent) {
								html += '<div class="alvobot-payload-section">';
								html += '<h6><i data-lucide="terminal" class="alvobot-icon" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;"></i> Comando cURL Equivalente:</h6>';
							...
							if (structData.full_response_body) {
								html += '<div class="alvobot-payload-section">';
								html += '<h6><i data-lucide="download" class="alvobot-icon" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;"></i> Resposta Completa da API:</h6>';
								try {
							...
							if (structData.rate_limit_info) {
								html += '<div class="alvobot-payload-section">';
								html += '<h6><i data-lucide="clock" class="alvobot-icon" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;"></i> Informações de Rate Limit:</h6>';
							...
							if (structData.cost_estimation) {
								html += '<div class="alvobot-payload-section">';
								html += '<h6><i data-lucide="coins" class="alvobot-icon" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;"></i> Estimativa de Custos:</h6>';
							...
							if (structData.error_details) {
								...
								html += '<h6><i data-lucide="x-circle" class="alvobot-icon" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;color:#dc2626;"></i> Detalhes do Erro:</h6>';
				...
				if (regularLogs.length > 0) {
					html += '<h5><i data-lucide="clipboard-list" class="alvobot-icon" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;"></i> Logs Regulares (' + regularLogs.length + '):</h5>';
			...
			html += '<h6><i data-lucide="code" class="alvobot-icon" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;"></i> Dados RAW Completos:</h6>';
