            ...
            <div class="alvobot-card">
                ...
                <div class="alvobot-card-content">
                    <div class="alvobot-stats-grid">
                        ...
                        <div class="alvobot-stat-item">
                            <div class="alvobot-stat-icon">
                                <span class="dashicons dashicons-<?php echo !empty($openai_settings['api_key']) ? 'yes-alt' : 'no-alt'; ?>"></span>
                            </div>
                            <div>
        ...
        <div class="alvobot-modal-body">
            <div id="connection-test-loading" style="display: none;">
                <div class="alvobot-loading">
                    <span class="dashicons dashicons-update alvobot-spin"></span>
            ...
            <div id="connection-test-result" style="display: none;">
                <div class="alvobot-test-result">
                    <div class="alvobot-result-icon">
                        <span class="dashicons" id="result-icon"></span>
                    </div>
...
jQuery(document).ready(function($) {
    ...
    function showTestResult(success, data) {
        ...
        if (success) {
            $('#result-icon').removeClass().addClass('dashicons dashicons-yes-alt').css('color', '#46b450');
            ...
            $('#result-icon').removeClass().addClass('dashicons dashicons-no-alt').css('color', '#dc3232');
    ...
    function resetStatistics() {
        ...
        $('#confirm-reset').prop('disabled', true).html('<span class="dashicons dashicons-update alvobot-spin"></span> Resetando...');
        ...
        $.ajax({
            ...
            success: function(response) {
                $('#confirm-reset').prop('disabled', false).html('<span class="dashicons dashicons-update-alt"></span> Resetar Estatísticas');
