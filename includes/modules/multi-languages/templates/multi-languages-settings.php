						...
						foreach ( $language_terms as $lang ) :
							...
							<tr>
								<td>
									...
									<?php if ( $is_default ) : ?>
										<i data-lucide="flag" class="alvobot-icon" style="color: #2271b1; margin-left: 5px;" title="<?php echo esc_attr__( 'Idioma padrão', 'alvobot-pro' ); ?>"></i>
									<?php endif; ?>
								</td>
								...
								<td>
									<?php if ( $is_default ) : ?>
										<i data-lucide="check-circle" class="alvobot-icon" style="color: green; font-size: 20px;"></i>
									<?php endif; ?>
								</td>
							</tr>
						<?php endforeach; ?>
