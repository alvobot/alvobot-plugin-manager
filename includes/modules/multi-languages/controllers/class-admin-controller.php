...
class AlvoBotPro_MultiLanguages_Admin_Controller {
    ...
    public function register_rest_routes() {
        ...
        register_rest_route($this->namespace, '/queue/status', array(
            'methods' => 'GET',
    ...
    public function register_post_translations_field() {
        ...
        foreach ($post_types as $post_type) {
            register_rest_field($post_type, 'pll_post_translations', array(
    ...
    private function render_tab_navigation($current_tab) {
        $tabs = array(
            'settings' => __('Configurações', 'alvobot-pro'),
            'openai' => __('OpenAI', 'alvobot-pro'),
            'queue' => __('Fila de Traduções', 'alvobot-pro'),
            'api-docs' => __('API Docs', 'alvobot-pro')
        );
