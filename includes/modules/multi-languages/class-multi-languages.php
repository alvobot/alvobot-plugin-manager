...
class AlvoBotPro_MultiLanguages {
    ...
    public function add_translate_row_action($actions, $post) {
        ...
        $actions['alvobot_translate'] = sprintf(
            '<a href="#" class="alvobot-translate-btn" data-post-id="%d" data-post-title="%s" data-post-type="%s" data-source-lang="%s"><span class="dashicons dashicons-translation" style="margin-right: 5px;"></span>%s</a>',
            $post->ID,
    ...
    private function localize_script_data() {
        ...
        wp_localize_script('alvobot-translation-interface', 'alvobotTranslation', array(
    ...
    private function init_autoloader() {
        $autoloader_path = dirname(__FILE__) . '/class-autoloader.php';
