 ...
 */
?>
<div class="wrap alvobot-essential-pages">
    <h1><?php esc_html_e('AlvoBot Essential Pages', 'alvobot-pro'); ?></h1>
    <p class="description"><?php esc_html_e('Gerencie as páginas essenciais do site. Veja abaixo o status atual e utilize as ações disponíveis para cada página.', 'alvobot-pro'); ?></p>
